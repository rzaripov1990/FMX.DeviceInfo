...
var
  ...
  /// <summary> получение информации о девайсе </summary>
procedure DeviceInfoByPlatform;
/// <summary> проверка есть ли интернет [ANDROID, WINDOWS] </summary>
function IsNetConnected: Boolean;

/// <summary> тип подключения к интернету [ANDROID, WINDOWS] </summary>
function IsNetConnectionType: TmyConnectionType;
/// <summary> тип мобильной сети [ANDROID] </summary>
function IsNetworkType: TmyNetworkType;

/// <summary> включен GPS? [ANDROID] </summary>
function IsGPSActive(HIGH_ACCURACY: Boolean = False): Boolean;

/// <summary> Тип девайса? [ALL PLATFORMS]</summary>
function IsDeviceType: TDeviceInfo.TDeviceClass;

/// <summary> Запущено на планшете или телефоне? [ALL PLATFORMS]</summary>
function IsTablet: Boolean;

/// <summary> Портретная ориентация? [ALL PLATFORMS] </summary>
